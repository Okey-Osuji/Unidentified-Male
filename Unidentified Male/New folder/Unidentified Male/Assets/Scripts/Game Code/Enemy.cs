...
public class Enemy : MonoBehaviour
{
    ...
    public Animator animator;// Reference to the Animator component, which can be used to control the enemy's animations based on its state and actions, such as walking, attacking, or dying
