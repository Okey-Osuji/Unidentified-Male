...
public class Enemy : MonoBehaviour
{
    ...
    public GameObject bulletPrefab;// Assign your new bullet here
    ...
    void Update()
    {
        // 1. IF THE ENEMY IS DEAD: Only listen for Consumption (E)
        if (isDead)
        {
            ...
            return; // Exit here so we don't run combat logic for a corpse
        }
    ...
    void Die()
    {
        ...
        {
            // THIS IS THE SMOKING GUN: If you see this in the console, the Inspector slot is actually empty
            Debug.LogError("FAILURE: " + gameObject.name + " has NO weapon assigned to weaponToDrop!");
        }
